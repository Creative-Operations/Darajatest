...
$CheckoutRequestID = 'ws_CO_03072023054410314768168060';  //check this id 
...
if (isset($data_to->ResultCode)) {
  ...
  if ($ResultCode == '1037') {
    $msage = "1037 Timeout in completing transaction";
  } elseif ($ResultCode == '1032') {
    $msage = "1032 Transaction  has cancelled by user";
  } elseif ($ResultCode == '1') {
    $msage = "1 The balance is insufficient for the transaction";
  } elseif ($ResultCode == '0') {
    $msage = "0 The transaction is successfully";
  }
}
